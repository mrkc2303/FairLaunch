...
const holders = [
  { name: "0xabcde... 🏛 (bonding curve)", percentage: "99.74%" },
  { name: "0xabcde...", percentage: "0.25%" },
  { name: "0xabcde...", percentage: "0.00%" },
  { name: "0xabcde...", percentage: "0.00%" },
  { name: "0xabcde...", percentage: "0.00%" },
  { name: "0xabcde...", percentage: "0.00%" },
];
...
export default function TokenDetail() {
  ...
  const bondingCurvePrice = (supplyChange) => {
    return (token.price + (supplyChange * 0.01)).toFixed(4);
  };
